...
def draw_bboxes_on_image(image_path, annotations, output_path=None, show_image=True):
    ...
    for ann in annotations:
        ...
        cv2.rectangle(img_rgb, (x1, y1), (x2, y2), colors.get(ann['label_name'], (0,255,0)), 2)
        cv2.putText(img_rgb, ann['label_name'], (x1, y1-10), 
                   cv2.FONT_HERSHEY_SIMPLEX, 0.5, colors.get(ann['label_name'], (0,255,0)), 2)
